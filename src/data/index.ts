...
export const experiences: Experience[] = [
  ...
  {
  id: "freelance-contadores",
  role: { es: "Desarrollador Frontend Freelance", en: "Freelance Frontend Developer" },
  company: "Consultoría de Contadores",
  period: { start: "Abr 2026", end: "May 2026" },
  location: "Remoto",
  remote: true,
  description: {
    es: "Landing page profesional en React con diseño responsive y optimización para conversión. Desplegada en Hostinger.",
    en: "Professional landing page in React with responsive design and conversion optimization. Deployed on Hostinger.",
  },
  tech: ["React", "Tailwind CSS", "Hostinger"],
  type: "freelance",
},
